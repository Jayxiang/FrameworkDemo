...
@interface CuijxQRController ()<AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    UIImageView *_line;
    NSInteger num;
    BOOL upOrdown;
...
@implementation CuijxQRController
